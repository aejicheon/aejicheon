<div align="center">
    <img src="https://capsule-render.vercel.app/api?type=waving&color=0:5858FA,100:BE81F7&height=180&text=Hello%20I'm%20CheonAeji&animation=&fontColor=ffffff&fontSize=60" />
</div>
...
<div>
    <h3>🍎 Team>최강애지팀 (캐쥬얼게임) {흑 화백} [<a href="https://github.com/aejicheon/DrawingLineGame">깃허브</a>]</h3><br>
    <ul> 
        <li>팀을 구성해 하반기 동안 Unity Engine을 사용해 스토리가 있는 캐쥬얼게임을 개발하였습니다.</li>
        <li>기간 : 2024.07 ~ 진행중</li>
        <li>게임내용 : 친구들과 멀티게임으로 그림을 그려 라운드 마다의 맵을 탈출하는 게임입니다.</li>
        <li>기술스택 : Unity Engine, c#</li>
        <li>구현부분 :
            <ul>
                <li>포톤을 사용해 멀티게임을 진행할 수 있게 로직 구현</li>
                <li>방을 만들거나 빠른시작을 통해 사람들과 게임 진행 가능하도록 로직 구현</li>
                <li>방에 들어가서 캐릭터를 소환하는 로직 구현</li>
            </ul>
        </li>
    </ul>
    <br>
    ...
    <ul> 
        ...
        <li>프로젝트내용 : 현재 한림대학교 공식앱은 구식이고, 안 쓰는 기능과, 필요하지만 없는 기능들이 존재하며, UI/UX가 효율적이지 못해 가독성도 떨어진다고 팀 회의를 하며 판단이 되어서 사람들이 필요한 자료를 찾기도 쉽게 ui/ux를 다시 구성해 보았습니다. </li>
        <li>기술스택 : Pigma</li>
        <li>구현부분 :
            <ul>
                ...
                <li>시간표 UI변경</li>
                <li>만든 UI를 클릭했을 때 원하는 ui로 이동가능하게 connection</li>
            </ul>
        </li>
    </ul>
    <img src="https://github.com/user-attachments/assets/85507c79-a61d-47cc-9edd-ce7f2f770393" width="275" height="250">
    <img src="https://github.com/user-attachments/assets/d8715b49-40c4-43e1-8753-6a2037653e95" width="275" height="250">
    <img src="https://github.com/user-attachments/assets/8b630113-888e-4542-b003-73e15fe26233" width="275" height="250">
    <br>
    ...
    <br>
    <h3>🥕 Android Studio를 사용한 장애물을 피해 목표 지점에 도달하는 캐주얼 게임   [<a href="https://github.com/aejicheon/ComputerGraphicsProject">깃허브</a>]</h3><br>
    <ul>
