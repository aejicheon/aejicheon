...
<div>
    ...
    🐋 2023 캡스톤 <br> 
    🍇 2023 증강현실기초및 실습 <br>
    🍉 Unreal Engine을 사용한 판타지 마을에서의 FPS슈팅 게임 <br>
    <ul>
    ...
    <ul>
        ...
        <li>r기술스택 : HTML, CSS, JS</li>
        <li>구현부분 : 웹 모든 ui/ux 디자인, 사이트 바로가기, 디자인한 ui/ux를 로직으로 모두 구현, 다양한 CSS로직 구현</li>
    </ul>
    <br>
    🍌 Unity Engine를 사용한 장애풀을 피해 목표 지점에 도달하는 캐주얼 게임<br>
    <ul>
        ...
        <li>r기술스택 : Android Studio, Kotlin</li>
        <li>구현부분 : 만들고 싶은 장애물 모양의 좌표를 찍고, 그 모형을 움직일 수 있게 로직을 구현, 목표물에 충돌했을때 로직 구현, 게임 ui구현</li>
    </ul>
    <br>
    🥑 Unity Engine를 사용한 마법사 판타지 FPS 게임 <br>
    <ul>
        ...
        <li>r기술스택 : Unity Engine, c#</li>
        <li>구현부분 : 플레이어의 다양한 공격 이펙트 구현, 게임 사운드 설정, 게임 시작, 오버, 게임 중 ui디자인 후, 구현, 맵 디자인, 캐릭터의 움직임 등의 로직 구현</li>
    </ul>
</div>
